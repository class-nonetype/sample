...
class Tickets(Base):
    ...
    resolution: Mapped[str] = mapped_column(Text, nullable=True, default=None)
    ...
    is_resolved: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=None)
    ...
    user_group_relationship: Mapped["UserGroups"] = relationship(
        "UserGroups",
